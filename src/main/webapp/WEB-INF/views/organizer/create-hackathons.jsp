        ...
        <div class="content-area">
            ...
            <div class="form-card">
                <div class="card-header-custom">
                    ...
                    <a href="${pageContext.request.contextPath}/organizer/hackathons" class="btn-light">
                        <i class="fas fa-arrow-left"></i> Back to List
                    </a>
                </div>

              <form action="${pageContext.request.contextPath}/organizer/save-hackathon" method="post" enctype="multipart/form-data">
